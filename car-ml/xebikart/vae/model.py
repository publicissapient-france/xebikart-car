...
class ConvVAE(object):
    ...
    def __init__(self, z_size=512, input_shape=(80, 160, 3), batch_size=100, learning_rate=0.0001,
    ...
    def _build_graph(self):
        ...
        with self.graph.as_default():
            ...
            self.output_tensor = tf.layers.conv2d_transpose(h, self.input_shape[3], 4, strides=2, activation=tf.nn.sigmoid,
                                                            name="dec_deconv4")
    ...
    def load(cls, load_path, **kwargs):
        ...
        # To load previous vae
        input_shape = data.get("input_shape", (80, 160, 3))
        model = cls(data['z_size'], input_shape, data['batch_size'],
