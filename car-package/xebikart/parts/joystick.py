...
class Joystick(PS3JoystickController):
    ...
    def add_trigger_action(self, button, action):
        self.button_down_trigger_map[button] = action
        self.default_actions[action] = False
...
class KeynoteJoystick(Joystick):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.add_trigger_action('cross', KeynoteDriver.EMERGENCY_STOP)
        self.add_trigger_action('square', KeynoteDriver.EXIT_SAFE_MODE)
